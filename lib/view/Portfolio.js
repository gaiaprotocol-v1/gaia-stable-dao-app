...
class Portfolio {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".portfolio-view", (0, skydapp_browser_1.el)("h1", "Portfolio"), this.interestDisplay = (0, skydapp_browser_1.el)("p"), (0, skydapp_browser_1.el)("section", "아직 이자를 통한 투자가 이루어지지 않았습니다.")));
        this.loadInterest();
    }
    async loadInterest() {
