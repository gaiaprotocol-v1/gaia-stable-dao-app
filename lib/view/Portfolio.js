...
class Portfolio {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".portfolio-view", (0, skydapp_browser_1.el)("h1", "Portfolio"), (0, skydapp_browser_1.el)("section.interest-container", this.interestKusdtDisplay = (0, skydapp_browser_1.el)("span", "..."), this.interestKrwDisplay = (0, skydapp_browser_1.el)("p")), (0, skydapp_browser_1.el)("section", new PortfolioItem_1.default(1, "stepn", "gmt", 3403, 2.67, "₩6,593,031.06 (1938.279905549 GMT)", "2022.05.08 ~ 2022.08.08"))));
        this.loadInterest();
    }
    async loadInterest() {
        ...
        this.interestKusdtDisplay.empty().appendText(`쌓여진 이자: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(mesh))} MESH`);
