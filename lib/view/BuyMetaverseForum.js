...
class Buy {
    ...
    async loadTab() {
        ...
        const address = await Wallet_1.default.loadAddress();
        if (address !== undefined) {
            this.ticket = (await GaiaStableDAOOperatorV2Contract_1.default.whitelistedAmount(address)).toNumber();
