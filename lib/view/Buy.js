...
class Buy {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".buy-view", (0, skydapp_browser_1.el)("h1", "Buy / Buyback"), (0, skydapp_browser_1.el)("img", { src: "/images/shared/img/img-logo.png", alt: "logo" }), (0, skydapp_browser_1.el)(".selector-container", this.salesDisplay = (0, skydapp_browser_1.el)("p", "SALES: ... EA"), this.ticketDisplay = (0, skydapp_browser_1.el)("p", "TICKET: ... 개"), this.priceDisplay = (0, skydapp_browser_1.el)("p", "PRICE: ... oUSDT"), this.totalDisplay = (0, skydapp_browser_1.el)("p", "TOTAL: ... oUSDT"), (0, skydapp_browser_1.el)(".select", this.kronosTab = (0, skydapp_browser_1.el)("a.disable", "Kronos", { click: () => this.loadTab("kronos") }), (0, skydapp_browser_1.el)("hr"), this.supernovaTab = (0, skydapp_browser_1.el)("a.disable", "Supernova", { click: () => this.loadTab("supernova") }), (0, skydapp_browser_1.el)("hr"), this.publicTab = (0, skydapp_browser_1.el)("a.disabled", "Public", { click: () => this.loadTab("public") }))), (0, skydapp_browser_1.el)(".input-container", this.notice = (0, skydapp_browser_1.el)("p"), (0, skydapp_browser_1.el)("input", {
            ...
            click: async () => {
                ...
                if (address !== undefined) {
                    if ((await KUSDTContract_1.default.allowance(address, GaiaStableDAOOperatorContract_1.default.address)).eq(0)) {
                        new Alert_1.default("오류", "oUSDT 사용 승인이 필요합니다.");
                    }
    ...
    async loadTab(type) {
        ...
        this.priceDisplay.empty().appendText(`PRICE: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatUnits(this.price, 6))} oUSDT`);
        this.loadTotal();
    }
    async loadTotal() {
        this.totalDisplay.empty().appendText(`TOTAL: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatUnits(this.count.mul(this.price), 6))} oUSDT`);
    }
    async loadNFTs() {
        this.nftList.empty();
        const address = await Wallet_1.default.loadAddress();
