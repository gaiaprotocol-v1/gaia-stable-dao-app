...
export interface IGaiaStableDAOInterface extends utils.Interface {
    contractName: "IGaiaStableDAO";
    functions: {
...
export interface IGaiaStableDAO extends BaseContract {
    contractName: "IGaiaStableDAO";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IGaiaStableDAOInterface;
...
//# sourceMappingURL=IGaiaStableDAO.d.ts.map