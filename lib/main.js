...
const BuyMetaverseForum_1 = __importDefault(require("./view/BuyMetaverseForum"));
...
(async () => {
    ...
    skydapp_common_1.SkyRouter.route("buy-metaverse-forum", BuyMetaverseForum_1.default);
